...
const Subscription = () => {
    ...
    return (
        <DashboardLayout activeMenu="Subscription">
            <div className="p-6">
                <h1 className="text-2xl font-bold mb-2 text-slate-900 dark:text-slate-100">Subscription Plans</h1>
                <p className="text-gray-600 dark:text-slate-400 mb-6">Choose a plan that works for you</p>
                ...
                <div className="flex flex-col md:flex-row gap-6 mb-8">
                    <div className="bg-blue-50 dark:bg-slate-800 p-6 rounded-lg border border-transparent dark:border-slate-700">
                        <div className="flex items-center gap-2 mb-4">
                            <CreditCard className="text-purple-500" />
                            <h2 className="text-lg font-medium text-slate-900 dark:text-slate-100">Current Credits: <span className="font-bold text-purple-500">{credits}</span></h2>
                        </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {plans.map((plan) => (
                        <BorderGlow
                            ...
                            animated={plan.recommended}
                            className="h-full"
                        >
                            <div
                                className={`border rounded-[12px] p-6 h-full flex flex-col ${plan.recommended
                                        ? 'border-purple-200 bg-purple-50 dark:bg-purple-900/20 dark:border-purple-500/30 shadow-md'
                                        : 'border-gray-200 bg-white dark:bg-slate-800 dark:border-slate-700'
                                    }`}
                            >
                                {plan.recommended && (
                                    <div className="inline-block bg-purple-500 text-white text-xs font-semibold px-3 py-1 rounded-full mb-4 self-start">
                                        RECOMMENDED
                                    </div>
                                )}
                                ...
                                <div className="mt-2 mb-4">
                                    ...
                                    <span className="text-gray-500 dark:text-slate-400"> for {plan.credits} credits</span>
                                </div>
                                ...
                                <button
                                    ...
                                    className={`w-full mt-auto py-2 rounded-md font-medium transition-colors ${plan.recommended
                                            ? 'bg-purple-500 text-white hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700'
                                            : 'bg-white border border-purple-500 text-purple-500 hover:bg-purple-50 dark:bg-transparent dark:text-purple-400 dark:border-purple-400 dark:hover:bg-purple-900/20'
                ...
                <div className="mt-8 bg-gray-50 dark:bg-slate-800 p-4 rounded-lg border border-gray-200 dark:border-slate-700">
                    <h3 className="font-medium mb-2 text-slate-900 dark:text-slate-100">How credits work</h3>
