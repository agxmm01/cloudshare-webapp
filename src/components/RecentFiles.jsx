    ...
    return (
        <div className="w-full">
            <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-medium text-slate-900 dark:text-slate-100">Recent Files ({files.length})</h2>
            </div>
                            ...
                            <tr key={file.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50">
                                <td className="px-4 py-3 whitespace-nowrap">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm font-medium text-slate-900 dark:text-slate-100 truncate max-w-[180px]" title={file.name}>
                                            {file.name}
                                        </span>
                                    </div>
                                </td>
                                ...
                                <td className="px-4 py-3 whitespace-nowrap">
                                    <div className="flex items-center">
                                        {file.public ? (
                                            ...
                                            <div className="flex items-center text-xs text-slate-900 dark:text-slate-100">
                            ...
                            <tr>
                                <td colSpan={5} className="px-4 py-12 text-center">
                                    <div className="flex flex-col items-center justify-center gap-3">
                                        ...
                                        <p className="text-slate-900 dark:text-slate-100 font-medium">No files uploaded yet.</p>
                                        <p className="text-slate-900 dark:text-slate-100 text-sm max-w-md">
